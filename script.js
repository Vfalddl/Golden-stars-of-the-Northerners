...
const awardsData = [
  ...
  },
  {
    ...
    type: "order",
    description: "Орден для награждения военнослужащих и партизан за подвиги в Великой Отечественной войны",
...
class MapManager {
  ...
  createMarker(coords, type, title, popupContent) {
    ...
    el.style.cssText = `
      ...
      font-size: 16px;
      color: white;
      background: ${type === 'birth' ? 'var(--gold)' : 'var(--danger)'};
    ...
    container.innerHTML = filteredAwards.map(award => `
      <div class="award-card" data-id="${award.id}">
        <div class="award-image">
          <img src="${award.image}" alt="${award.name}" loading="lazy" style="object-fit: contain;">
    ...
    container.innerHTML = monumentsData.map(monument => `
      <div class="monument-card" data-id="${monument.id}">
        <div class="monument-image">
          <img src="${monument.image}" alt="${monument.name}" loading="lazy" style="object-fit: cover; width: 100%; height: 100%;">
...
class QuizManager {
  ...
  showResults() {
    ...
    if (scorePercent >= 90) {
      message = 'Отличный результат! Вы прекрасно знаете историю героев-северянов!';
      icon = '🏆';
...
class TeamManager {
    ...
    this.teamData = [
      {
        ...
        responsibilities: [
          ...
          "Разработка основного JavaScript-кода (script.js)",
          "Интеграция интерактивных карт MapLibre GL",
          "Реализация системы аудиогида",
          "Координация работы команды",
          "Отладка и оптимизация производительности"
        ],
        achievements: [
          "Создал комплексную систему управления данными 10 героев",
          "Реализовал интерактивную карту с маркерами мест рождения и подвигов",
          "Разработал систему поиска и фильтрации данных",
          "Интегрировал аудиогид с поддержкой речи браузера",
          "Создал интерактивный тест на знание истории героев"
        ],
        avatar: "fas fa-code",
        tech: ["JavaScript", "MapLibre", "Web Speech API", "HTML5", "CSS3"]
      },
      {
        id: 2,
        name: "Зверева Ирина",
        ...
        responsibilities: [
          "Разработка дизайн-системы и визуальной концепции",
          "Создание пользовательского интерфейса",
          "Верстка HTML/CSS компонентов",
          "Адаптивная верстка для мобильных устройств",
          "Анимации и интерактивные элементы"
        ],
        achievements: [
          "Разработала уникальный дизайн с 'северной' тематикой",
          "Создала систему тем (светлая/темная)",
          "Реализовала анимации прелоадера и переходов",
          "Разработала компоненты карточек героев, наград и памятников",
          "Создала адаптивный дизайн для всех разрешений экрана"
        ],
        avatar: "fas fa-palette",
        tech: ["UI/UX", "CSS3", "HTML5", "Figma", "Adobe Creative Suite"]
      },
      {
        id: 3,
        name: "Белозёрцев Вадим",
        role: "Разработчик базы данных и бэкенда",
        responsibilities: [
          "Структурирование данных о героях",
          "Создание системы хранения информации о наградах",
          "Разработка системы событий временной шкалы",
          "Оптимизация загрузки данных",
          "Создание системы офлайн-работы приложения"
        ],
        achievements: [
          "Подготовил структурированные данные о 10 героях",
          "Создал базу данных наград (8 основных типов)",
          "Разработал систему временной шкалы событий",
          "Реализовал кэширование данных для офлайн-работы",
          "Оптимизировал загрузку изображений и контента"
        ],
        avatar: "fas fa-database",
        tech: ["Data Architecture", "JSON", "LocalStorage", "API Design"]
      },
      {
        id: 4,
        name: "Мельгунов Дмитрий, Задорин Денис",
        role: "Разработчики интерактивной карты",
        responsibilities: [
          "Интеграция и настройка MapLibre GL",
          "Разработка системы маркеров и поп-апов",
          "Реализация 2D/3D режимов карты",
          "Оптимизация производительности карты",
          "Геокодирование местоположений"
        ],
        achievements: [
          "Интегрировал интерактивную карту с двумя типами маркеров",
          "Реализовал 3D режим просмотра карты",
          "Разработал систему подсказок и легенды карты",
          "Оптимизировал отображение 20+ маркеров",
          "Создал адаптивную карту для мобильных устройств"
        ],
        avatar: "fas fa-map",
        tech: ["MapLibre GL", "GeoJSON", "GIS", "3D Visualization"]
      },
      {
        id: 5,
        name: "Ившин Владислав, Суховский Егор",
        role: "Разработчики системы аудиогида",
        responsibilities: [
          "Интеграция Web Speech API",
          "Разработка системы текстового озвучивания",
          "Создание интерфейса управления аудиогидом",
          "Реализация многоязычной поддержки",
          "Оптимизация работы синтеза речи"
        ],
        achievements: [
          "Разработал полноценную систему аудиогида",
          "Реализовал управление скоростью и голосом",
          "Создал автоматическое озвучивание контента",
          "Настроил кнопки аудио на всех карточках",
          "Разработал систему аудио-анимаций"
        ],
        avatar: "fas fa-volume-up",
        tech: ["Web Speech API", "Audio Processing", "TTS", "Accessibility"]
      },
      {
        id: 6,
        name: "Савиди Александр",
        role: "Разработчик интерактивного теста",
        responsibilities: [
          "Разработка системы вопросов и ответов",
          "Создание трех уровней сложности",
          "Реализация таймера и системы подсчета очков",
          "Разработка интерфейса результатов",
          "Создание системы проверки знаний"
        ],
        achievements: [
          "Разработал 30 уникальных вопросов (3 уровня сложности)",
          "Реализовал систему подсчета очков и таймера",
          "Создал интерактивный интерфейс теста",
          "Разработал систему отображения результатов",
          "Интегрировал озвучивание результатов"
        ],
        avatar: "fas fa-question-circle",
        tech: ["Game Design", "Quiz Logic", "Scoring Systems", "UI/UX"]
      },
      {
        id: 7,
        name: "Репицкий Дмитрий",
        role: "Разработчик системы наград",
        responsibilities: [
          "Создание системы классификации наград",
          "Разработка интерфейса фильтрации наград",
          "Создание визуального представления наград",
          "Интеграция связи 'герой-награда'",
          "Разработка детальных описаний наград"
        ],
        achievements: [
          "Создал систему из 8 типов наград",
          "Разработал фильтры по типам наград",
          "Реализовал визуальное отображение наград",
          "Создал связи между героями и их наградами",
          "Разработал детальные описания каждой награды"
        ],
        avatar: "fas fa-award",
        tech: ["Data Modeling", "Filter Systems", "UI Components", "Content Management"]
      },
      {
        id: 8,
        name: "Ряхин Сергей",
        role: "Разработчик системы памятников",
        responsibilities: [
          "Создание базы данных памятников",
          "Разработка карты памятников",
          "Интеграция связи 'памятник-герой'",
          "Создание визуальных компонентов памятников",
          "Разработка системы фильтрации памятников"
        ],
        achievements: [
          "Создал базу из 5 памятников и мемориалов",
          "Разработал отдельную карту памятников",
          "Реализовал связи между памятниками и героями",
          "Создал визуальные карточки памятников",
          "Разработал систему фильтрации по типам памятников"
        ],
        avatar: "fas fa-landmark",
        tech: ["Database Design", "Map Integration", "Visual Design", "Filter Systems"]
      },
      {
        id: 9,
        name: "Перхуров Даниил",
        role: "Разработчик системы поиска",
        responsibilities: [
          "Разработка полнотекстового поиска",
          "Создание системы индексации данных",
          "Реализация умного поиска по всем полям",
          "Разработка интерфейса поиска",
          "Создание системы подсказок поиска"
        ],
        achievements: [
          "Реализовал полнотекстовый поиск по всем данным",
          "Создал систему индексации для быстрого поиска",
          "Разработал интерфейс поиска с подсказками",
          "Реализовал дебаунсинг для оптимизации",
          "Создал систему отображения результатов поиска"
        ],
        avatar: "fas fa-search",
        tech: ["Search Algorithms", "Indexing", "Debouncing", "UI/UX"]
      },
      {
        id: 10,
        name: "Алимов Артём",
        role: "Тестировщик и оптимизатор",
        responsibilities: [
        ...
        achievements: [
          "Провел комплексное тестирование всех функций",
          "Оптимизировал загрузку ресурсов",
          "Исправил 50+ ошибок в коде",
          "Проверил совместимость с 5+ браузерами",
          "Оптимизировал производительность для мобильных устройств"
        ],
        avatar: "fas fa-bug",
        tech: ["QA Testing", "Performance Optimization", "Cross-browser", "Debugging"]
      }
    ];
    
    // Добавляем аудиоконтент для аудиогида
    this.audioContent = {
      team: "Раздел 'Команда' представляет разработчиков проекта 'Золотые Звёзды Северян'. В проекте участвовало 12 студентов группы 15 15 18: главный разработчик, дизайнер, специалист по базам данных, разработчики карты и аудиогида, тестировщик и другие. Каждый из них внес важный вклад в создание этого образовательного ресурса.",
      features: "Функционал проекта включает интерактивную карту с маркерами мест рождения и подвигов героев, систему аудиогида с синтезом речи, интерактивный тест на знание истории, адаптивный дизайн для всех устройств и полнотекстовый поиск по всем данным проекта.",
      tech: "Технологический стек проекта включает современные веб-технологии: HTML5 для структуры, CSS3 для стилей и анимаций, JavaScript для интерактивности, MapLibre GL для интерактивных карт, Web Speech API для аудиогида и PWA для офлайн-работы приложения."
    };
    ...
    container.innerHTML = this.teamData.map(member => `
      <div class="team-card" data-id="${member.id}">
        <div class="team-avatar">
          <div class="avatar-icon" style="background: var(--gold-gradient);">
            <i class="${member.avatar}" style="font-size: 2.5rem; color: white;"></i>
          </div>
        ...
        <div class="team-info">
          ...
          <div class="team-tech">
            ${member.tech.map(tech => `<span class="tech-tag">${tech}</span>`).join('')}
          </div>
          <div class="team-responsibilities">
            <h4><i class="fas fa-tasks"></i> Основные обязанности:</h4>
            <ul>
              ${member.responsibilities.map(resp => `<li>${resp}</li>`).join('')}
            </ul>
          </div>
          <div class="team-achievements">
            <h4><i class="fas fa-trophy"></i> Ключевые достижения:</h4>
            <ul>
              ${member.achievements.map(ach => `<li>${ach}</li>`).join('')}
            </ul>
          </div>
        </div>
      </div>
    ...
    const features = [
      {
        ...
        description: "Использование MapLibre GL для отображения карт с 2D/3D режимами просмотра",
        details: [
          "20+ интерактивных маркеров",
          "Поп-апы с информацией о героях",
          "Адаптивный дизайн карты",
          "Легенда карты с различными типами маркеров"
        ],
        icon: "fa-globe-europe"
      },
      {
        title: "Система аудиогида",
        description: "Интеграция Web Speech API для озвучивания контента",
        details: [
          "Поддержка русского языка",
          "Управление скоростью и голосом",
          "Автоматическое озвучивание контента",
          "Аудио-анимации и индикация"
        ],
        icon: "fa-headphones"
      },
      {
        title: "Интерактивный тест",
        description: "Система проверки знаний о героях-северянах",
        details: [
          "3 уровня сложности (30 вопросов)",
      ...
      },
      {
        ...
        description: "Современный отзывчивый интерфейс",
        details: [
      ...
      },
      {
        ...
        description: "Умный поиск по всем данным проекта",
        details: [
      ...
      },
      {
        ...
        description: "Возможность использования без интернет-соединения",
        details: [
          "Кэширование данных",
  ...
  setupAudioGuide() {
    // Добавляем аудио контент в глобальный аудиогид
    if (window.audioGuide && window.audioGuide.audioContent) {
      // Добавляем контент для секции команды
      window.audioGuide.audioContent.team = this.audioContent.team;
      window.audioGuide.audioContent.features = this.audioContent.features;
      window.audioGuide.audioContent.tech = this.audioContent.tech;
    }

    // Добавляем обработчики для аудиогида в секции команды
    const teamSection = document.getElementById('team');
    if (teamSection) {
      teamSection.addEventListener('click', (e) => {
        if (window.audioGuide && window.audioGuide.autoPlayEnabled) {
          const target = e.target.closest('.team-card, .feature-card, .tech-stack-item');
          if (target) {
            this.handleAudioForElement(target);
          }
        }
      });
    }
  ...
  handleAudioForElement(element) {
    if (!window.audioGuide || !window.audioGuide.autoPlayEnabled) return;

    let audioText = '';
    
    if (element.classList.contains('team-card')) {
      const name = element.querySelector('.team-name')?.textContent || '';
      const role = element.querySelector('.team-role-badge')?.textContent || '';
      audioText = `Член команды: ${name}. Роль: ${role}.`;
    }
    else if (element.classList.contains('feature-card')) {
      const title = element.querySelector('h3')?.textContent || '';
      const description = element.querySelector('p')?.textContent || '';
      audioText = `Функция проекта: ${title}. ${description}`;
    }
    else if (element.classList.contains('tech-stack-item')) {
      const techName = element.querySelector('span')?.textContent || '';
      const description = element.querySelector('p')?.textContent || '';
      audioText = `Технология: ${techName}. ${description}`;
    }

    if (audioText && window.audioGuide.speak) {
      window.audioGuide.speak(audioText);
    }
  }

  // Метод для описания секции командой (вызывается из аудиогида)
  describeTeamSection(section) {
    if (this.audioContent[section]) {
      if (window.audioGuide && window.audioGuide.speak) {
        window.audioGuide.speak(this.audioContent[section]);
      }
    }
  }
}
  ...
  createHeroCard(hero) {
    ...
    card.innerHTML = `
      <div class="hero-img-container">
        <img src="${hero.img}" alt="${hero.fio}" class="hero-img" loading="lazy" style="object-fit: cover; width: 100%; height: 100%;">
    ...
    switch(sectionId) {
      ...
      case 'team':
        if (!this.teamManager) {
          ...
          // Автоматическое воспроизведение аудиогида при открытии секции
          if (window.audioGuide && window.audioGuide.autoPlayEnabled) {
            setTimeout(() => {
              this.teamManager.describeTeamSection('team');
            }, 1000);
          }
        }
        break;
