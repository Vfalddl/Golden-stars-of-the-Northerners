...
class AudioGuide {
  constructor() {
    ...
    this.audioContent = {
      ...
      team: "В разделе 'Команда' представлена информация о разработчиках проекта. Над созданием сайта работала команда из 12 человек, каждый из которых отвечал за свою часть проекта: разработку интерфейса, картографии, аудиогида, тестирования и других компонентов. Команда использовала современные технологии, включая HTML5, CSS3, JavaScript, MapLibre GL и Web Speech API.",
      developers: "Над проектом работали: Худяков Максим - главный разработчик, Зверева Ирина - дизайнер, Белозёрцев Вадим - разработчик базы данных, Мельгунов Дмитрий и Задорин Денис - картография, Ившин Владислав и Суховский Егор - аудиогид, Александр Савиди - интерактивный тест, Репицкий Дмитрий - система наград, Ряхин Сергей - памятники, Перхуров Данил - поиск, Алимов Артём - тестирование и оптимизация.",
      technologies: "Проект использует современный технологический стек: HTML5 для семантической разметки, CSS3 для стилизации и анимаций, JavaScript для интерактивности, MapLibre GL для интерактивных карт, Web Speech API для аудиогида и PWA для офлайн-работы.",
      mission: "Миссия проекта - создание интерактивного образовательного ресурса для сохранения памяти о героях-северянах Великой Отечественной войны, описанных в книге Р.А. Овсянкина. Мы стремимся сделать историю живой и доступной для всех поколений.",
  ...
  setupEventListeners() {
    ...
    // Воспроизведение при клике на карточки команды
    const teamSection = document.getElementById('team');
    if (teamSection) {
      teamSection.addEventListener('click', (e) => {
        if (e.target.closest('.team-card') && this.autoPlayEnabled) {
          const teamCard = e.target.closest('.team-card');
          const memberId = teamCard.dataset.id;
          this.describeTeamMember(memberId);
        }
      });
    }
  ...
  describeTeamMember(memberId) {
    const members = [
      { id: 1, description: "Худяков Максим - главный разработчик. Отвечал за архитектуру и структуру проекта, разработку основного JavaScript-кода, интеграцию интерактивных карт и системы аудиогида." },
      { id: 2, description: "Зверева Ирина - дизайнер и фронтенд-разработчик. Создала дизайн-систему, пользовательский интерфейс и адаптивную верстку." },
      { id: 3, description: "Белозёрцев Вадим - разработчик базы данных. Структурировал данные о героях, создал систему хранения информации и оптимизировал загрузку." },
      { id: 4, description: "Мельгунов Дмитрий и Задорин Денис - разработчики интерактивной карты. Интегрировали MapLibre GL с 2D/3D режимами и системой маркеров." },
      { id: 5, description: "Ившин Владислав и Суховский Егор - разработчики системы аудиогида. Интегрировали Web Speech API для озвучивания контента." },
      { id: 6, description: "Александр Савиди - разработчик интерактивного теста. Создал систему проверки знаний с тремя уровнями сложности." },
      { id: 7, description: "Репицкий Дмитрий - разработчик системы наград. Создал классификацию наград и визуальное представление." },
      { id: 8, description: "Ряхин Сергей - разработчик системы памятников. Создал базу данных памятников и карту мемориалов." },
      { id: 9, description: "Перхуров Данил - разработчик системы поиска. Реализовал полнотекстовый поиск по всем данным проекта." },
      { id: 10, description: "Алимов Артём - тестировщик и оптимизатор. Провёл комплексное тестирование и оптимизацию производительности." }
    ];

    const member = members.find(m => m.id === parseInt(memberId));
    if (member) {
      this.speak(member.description);
    }
  }
